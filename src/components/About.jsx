...
function About() {
  ...
  return (
    <div className="m-auto flex h-screen w-[1024px] items-center justify-center text-center max-md:w-full max-md:px-4 ">
      <motion.div
        whileInView={{ y: [100, 50, 0], opacity: [0, 0, 1] }}
        transition={{ duration: 0.7, ease: "easeInOut" }}
      >
        <span
          className="select-none text-[3.5rem] font-semibold text-black dark:text-[#ded3c3] max-2xl:text-[3.2rem] max-sm:text-[2rem]"
