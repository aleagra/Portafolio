...
function About() {
  ...
  return (
    <div className="m-auto flex h-screen w-[1200px] items-center justify-center text-center max-md:w-full max-md:px-4 ">
      <motion.div
        whileInView={{ y: [100, 50, 0], opacity: [0, 0, 1] }}
        transition={{ duration: 0.7, ease: "easeInOut" }}
      >
        <span
          className="select-none text-[4rem] font-bold text-black dark:text-white max-2xl:text-[3.2rem] max-sm:text-[2rem]"
