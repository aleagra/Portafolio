...
export function Home() {
  ...
  return (
    <motion.div
      whileInView={{ y: [100, 75, 50, 25, 0], opacity: [0, 0.5, 1] }}
        ...
        <div className="flex flex-col items-center mt-20 max-xl:w-[100%] max-lg:flex-col md:pt-0 2xl:w-[85%]">
          ...
          <div className="flex w-full flex-col justify-center items-center text-center 2xl:w-1/2">
            <div className="z-20 w-fit flex flex-col justify-center items-center max-2xl:px-10 max-2xl:mx-auto max-md:px-0">
              <span
                className="m-0 p-0 mb-2 text-[6rem] font-bold leading-[7rem] text-black dark:text-[#dfd3c3] max-2xl:text-[5rem] max-lg:text-[4rem] max-sm:text-[2rem] max-sm:leading-[5rem]"
              ...
              <span
                className="text-[2rem] text-black/80 dark:text-white font-bold max-sm:text-lg"
