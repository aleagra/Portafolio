			...
			>
				...
				>
					<section className="bg-gray-100 rounded-lg overflow-hidden relative h-[22rem] max-lg:h-[18rem] hover:bg-gray-200 transition  dark:text-white dark:bg-white/10 dark:hover:bg-white/20 button dark:hover:text-black">
						<div className="pt-4 pb-7 px-5 max-2xl:px-0 sm:pl-10 sm:group-even:pl-10 sm:pr-8 sm:pt-10 justify-center mr-[30rem] max-lg:mr-[10rem] flex flex-col h-full max-lg:group-even:ml-[10rem] group-even:ml-[30rem] group-even:mr-0">
						...
						<img
							...
							className="absolute hidden sm:block top-0 -right-0 w-[30rem] max-lg:w-[10rem] transition group-even:right-[initial] group-even:-left-0"
						/>
					</section>
				</a>
			</motion.div>
