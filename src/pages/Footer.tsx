...
const Footer: React.FC = () => {
	const { liRefs, handleMouseEnter, handleMouseLeave } = useContext(MouseContext) || {}
			...
			<div className="">
				...
				<div className="flex w-full flex-wrap items-end justify-center gap-8 py-6 dark:text-white ">
					...
					<div className="flex w-full justify-center">
						<h1 className="select-none py-3 bg-white/10 rounded-xl px-6">Hecho por Alejandro Agra.</h1>
					</div>
				</div>
			</div>
		</>
...
export default () => <Wrapper Component={Footer} idName="Contact" title="Contacto" />
