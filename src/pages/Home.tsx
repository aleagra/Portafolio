...
const Home: React.FC = () => {
	...
	return (
		<section className="relative z-[1] flex h-screen select-none flex-col items-center pt-24 max-md:pt-[8rem]" id="Home">
			<div className="flex flex-col items-center mt-20 max-xl:w-[100%] max-lg:flex-col md:pt-0 2xl:w-[85%]">
				<div className="mt-[-5.5rem] flex w-full flex-col justify-center outline-none 2xl:w-1/2">
					<div ref={animationContainer} className="mx-auto max-xl:w-full max-lg:w-[80%] max-sm:w-full 2xl:w-[90%] player" />
				</div>
